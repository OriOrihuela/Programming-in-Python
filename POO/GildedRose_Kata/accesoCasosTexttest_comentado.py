    ...
    try:
        ...
        for linea in fichero:
            ...
            if linea.find("day") != -1:
                ...
                ### CREAR LA FUNCIÓN QUE CONVIERTA DE "STRING" A "INT" AQUÍ ###

        fromStr_toInt(matrizCasosTest)
...
def fromStr_toInt(array):
    for element in array:
        for subelement in element:
            for (offset,item) in enumerate(subelement):
                    if offset > 0:
                        subelement[offset] = int(item)
    return array
